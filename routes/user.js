...
const { registerCustomer, verifyUser, login, getUserDetailsById, updateProfile, deleteUser, forgotPassword, resetPasswordForm, resetPassword } = require('../controllers/user');
...
router.post('/reset-password', resetPassword);    // handle reset
